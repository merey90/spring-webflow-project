...
<head>
	...
	<title><spring:message code="sign_up" /> | webflow-tutorial</title>
		...
		<div class="jumbotron">
			<div class="row">
				<form:form method="POST" modelAttribute="user" class="form col-xs-12 col-sm-6 col-sm-offset-3 form-vertical">
					<h3><spring:message code="sign_up" /></h3>
					...
					<div class="form-group text-right">
						<input type="submit" class="btn btn-default" value="<spring:message code="cancel" />" name="_eventId_cancel">
						<input type="submit" class="btn btn-primary" value="<spring:message code="register" />" name="_eventId_create">
					</div>
