...
<head>
	...
	<title><spring:message code="otp" /> | webflow-tutorial</title>
...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			...
			<div class="row">
				<form:form method="POST" modelAttribute="otpModel" class="form col-xs-12 col-sm-6 col-sm-offset-3 form-vertical">
					<h3><spring:message code="otp_confirm" /> <small>${otp}</small></h3>
					<div class="form-group">
						<form:label path="code">
							<spring:message code="otp_label" />
						</form:label>
					...
					<div class="form-group btn-group">
						...
						<button class="btn btn-default" type="submit" name="_eventId_resend"><spring:message code="resend"/></button>
